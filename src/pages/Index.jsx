  ...
  return (
    <div className="overflow-hidden" onMouseMove={handleMouseMove}>
      ...
      <section ref={heroRef} className="relative min-h-[100svh] flex items-center section-base industrial-pattern overflow-hidden">
        ...
        {/* Floating Gear Background Parallax */}
        <motion.div 
          style={{ y: gearY, rotate: gearRotation }}
          className="absolute -right-24 top-24 opacity-[0.03] pointer-events-none hidden lg:block"
        >
        ...
        <div className="container-section text-center relative z-20">
          <SectionReveal>
            ...
            <div className="flex flex-col items-center justify-center gap-3">
              <a
                href="https://wa.me/971558599045"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-white text-primary px-12 py-5 rounded-2xl font-display font-extrabold text-[16px] hover:scale-[1.03] hover:brightness-105 shadow-[0_8px_20px_rgba(0,0,0,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.4)] transition-all duration-400 group relative overflow-hidden"
              >
              ...
              <p className="text-white/80 text-[13px] font-medium tracking-wide mt-1 text-center">
