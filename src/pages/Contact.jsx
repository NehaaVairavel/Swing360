                  ...
                  },
                  {
                    ...
                    content: (
                      <div className="mt-2 flex flex-col gap-2">
                        <a href="tel:+971558599045" className="text-sm font-bold text-muted-foreground hover:text-primary transition-colors block">
                          📞 +971 55 859 9045
                        </a>
                        <a href="tel:+918778868739" className="text-sm font-bold text-muted-foreground hover:text-primary transition-colors block">
                          📞 +91 87788 68739
                        </a>
                      </div>
                    ),
