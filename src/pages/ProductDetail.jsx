            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                ...
                <a
                  ...
                  className="flex-1 bg-white border-2 border-charcoal/5 text-heading py-5 px-8 flex items-center justify-center gap-3 rounded-[1.5rem] font-black tracking-widest text-[13px] hover:border-primary/30 hover:bg-primary/5 transition-all"
                >
