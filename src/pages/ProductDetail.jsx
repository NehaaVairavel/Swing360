            ...
            >
              ...
              <div className="bg-gray-50/60 rounded-2xl p-4 mb-5 border border-gray-100 relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between gap-4 relative z-10">
                  <div>
                    ...
                    <h2 className="text-4xl font-display font-black text-primary tracking-tighter drop-shadow-sm whitespace-nowrap">{formatPrice(product.priceUSD)}</h2>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="w-full bg-primary text-white py-4 px-8 flex items-center justify-center gap-3 rounded-2xl font-black uppercase tracking-widest text-[13px] shadow-[0_16px_32px_-8px_rgba(245,158,11,0.45)] hover:shadow-[0_20px_40px_-8px_rgba(245,158,11,0.6)] hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 group"
                >
              ...
              {/* WhatsApp CTA */}
              <a
                href="https://wa.me/918778868739"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-3 w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl bg-[#25D366]/10 border border-[#25D366]/25 text-[#1a9e4d] hover:bg-[#25D366] hover:text-white hover:border-[#25D366] hover:shadow-[0_8px_20px_-6px_rgba(37,211,102,0.5)] transition-all duration-300 font-black uppercase tracking-widest text-[12px] hover:-translate-y-0.5 group"
              >
